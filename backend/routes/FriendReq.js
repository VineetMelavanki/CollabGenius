...
const {SendFriendRequest,fetchAllfriendRequests,acceptFriendRequest,declineFriendRequest,checkrequests}=require("../controllers/FriendRequest")
...
FriendRequestRouter.post("/check-requests",authmiddleware,checkrequests);
