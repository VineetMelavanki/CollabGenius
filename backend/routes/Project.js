...
const {CreateProject,Getallprojects,getprojectbyId,deleteproject,yourprojects,addmembers,removemember,getprojectByname}=require("../controllers/Project");
...
ProjectRouter.get("/get-project-by-title",authmiddleware,getprojectByname);
