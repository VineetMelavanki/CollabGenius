...
export default function NoresNodup({handlesubmit,handlechange,dashboardprompt}){
    const {user}=useAuth();
    return(
        <div className="flex flex-col w-full items-center justify-center gap-2 border p-4">
                ...
                <div className="w-full max-w-md">
                    <form onSubmit={handlesubmit} className="flex items-center gap-2 rounded-xl px-4 py-2  shadow-lg">
                      <input
                      type="text"
                      name="prompt"
                      ...
                      />
                      <button className="bg-red-400 rounded-full p-1" type="submit">
